            ...
            <Coverparticles/>
                        ...
                        <div className="title-projects"><h2 >SOME THINGS I HAVE BUILT</h2></div>
                            ...
                            <div className="card-inner">
                                        ...
                                        <img src="https://res.cloudinary.com/josepcortes/image/upload/v1716316460/Captura_desde_2024-05-21_20-33-49_ykxpnj.png" alt="" /> 
                                        </div>
                                        <div className="card-back">
                                            <ul>
                                                <li className="card-title-back">BACARDI GAINS</li>
                                                <li><p>-Personal project, in order to practise JQuery. </p></li>
                                                <li><p>-Web, where I create an ecomerce, in order to practise JQuery. User can create products and get it into a cart. </p></li>
                                                <li><p>-This project has no backend. I save all the dates in the LocaleStorage, and the initial images are from cloudinary.  </p></li>
                                                <li><p>Link to github repository:</p></li>
                                            </ul>

                                            <div className="git-box">
                                                <a href="https://github.com/josepCortesManyanich/JQuery-PRACTISE" target="_blank"  rel="noreferrer"><img className="button-git" src="https://res.cloudinary.com/josepcortes/image/upload/v1713896520/64e79ca5aff2fb7295bfddf9_github-que-es_vwvfsc.jpg" alt="" /></a>
                                            </div>
                                            <div className="lenguajes"> <p>HTML5</p> <p>CSS3</p> <p>JS</p> <p>JQUERY</p> </div>
                                        </div>
